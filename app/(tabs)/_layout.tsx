...
import { TabIconWithPulse } from "../../components/achievements/TabIconWithPulse";
...
export default function TabLayout() {
  ...
  return (
    ...
    >
      <Tabs.Screen name="train" options={{ title: "Train", headerShown: false, tabBarIcon: ({ color, size, focused }) => <Ionicons name={focused ? "flame" : "flame-outline"} size={size} color={color} /> }} />
      ...
      <Tabs.Screen name="log" options={{ title: "Activity", tabBarIcon: ({ color, size, focused }) => (
        <TabIconWithPulse>
