...
export default function TabLayout() {
  ...
  return (
    ...
    >
      <Tabs.Screen name="index" options={{ title: "Train", headerTitle: "Hybrid Rockstar", tabBarIcon: ({ color, size, focused }) => <Ionicons name={focused ? "flame" : "flame-outline"} size={size} color={color} /> }} />
