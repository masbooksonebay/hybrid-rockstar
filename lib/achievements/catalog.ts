...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  { id: "halfway_there", name: "Halfway There", description: "Complete Week 6 — you are halfway done",     sfSymbol: "hourglass.tophalf.filled", colorHex: "#FF9500" },
  ...
  { id: "half_send",     name: "Half Send",     description: "Complete a HalfRox-tier session",            sfSymbol: "star.leadinghalf.filled",  colorHex: "#FF2D55" },
];
